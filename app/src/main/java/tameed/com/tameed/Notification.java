...
public class Notification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedIntancestate) {
        ...
        clear_notification = (TextView) findViewById(R.id.notification_clear_all);
        ...
        clear_notification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Build.VERSION.SDK_INT >= 11) {
                    alert = new AlertDialog.Builder(Notification.this, AlertDialog.THEME_HOLO_LIGHT);
                } else {
                    alert = new AlertDialog.Builder(Notification.this);
                }
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                ssp.setNotification_id(Notification.this, notification_id);
                         ...
                         /*   Notification_detail.addAll(list);
                            ...
                            {
                                notification_adapter = new Notification_Adapter(Notification.this,Notification_detail);
                                recyclerView.setAdapter(notification_adapter);
                            } else {
...
//
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (error instanceof TimeoutError || error instanceof NoConnectionError) {
                            ...
                            Toast.makeText(Notification.this, getResources().getString(R.string.login_error), Toast.LENGTH_LONG).show();
                        } else if (error instanceof AuthFailureError) {
                            Toast.makeText(Notification.this, getResources().getString(R.string.time_out_error), Toast.LENGTH_LONG).show();
                            //TODO
                        } else if (error instanceof ServerError) {

                            Toast.makeText(Notification.this, getResources().getString(R.string.server_error), Toast.LENGTH_LONG).show();
                            //TODO
                        } else if (error instanceof NetworkError) {
                            Toast.makeText(Notification.this, getResources().getString(R.string.networkError_Message), Toast.LENGTH_LONG).show();
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("user_id", ssp.getUserId(Notification.this));
...
//
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (error instanceof TimeoutError || error instanceof NoConnectionError) {
                            ...
                            Toast.makeText(Notification.this, "Time Out Error", Toast.LENGTH_LONG).show();
                        } else if (error instanceof AuthFailureError) {
                            Toast.makeText(Notification.this, "Authentication Error", Toast.LENGTH_LONG).show();
                            //TODO
                        } else if (error instanceof ServerError) {

                            Toast.makeText(Notification.this, "Server Error", Toast.LENGTH_LONG).show();
                            //TODO
                        } else if (error instanceof NetworkError) {
                            Toast.makeText(Notification.this, "Network Error", Toast.LENGTH_LONG).show();
    ...
    private void showProgDialog() {
        ...
        try {
            if (Build.VERSION.SDK_INT >= 11) {
                progress_dialog = new ProgressDialog(Notification.this, AlertDialog.THEME_HOLO_LIGHT);
            } else {
                progress_dialog = new ProgressDialog(Notification.this);
            }
