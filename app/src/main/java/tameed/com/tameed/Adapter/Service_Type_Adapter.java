...
public class Service_Type_Adapter extends RecyclerView.Adapter<Service_Type_Adapter.ItemViewHolder> {

    public LayoutInflater inflater;
    Context context;
    float rate;
    ArrayList<Service_Category_Entity.Services_Entity> multiple_image_list = new ArrayList<Service_Category_Entity.Services_Entity>();
    ...
    public Service_Type_Adapter(Context applicationContext,   ArrayList<Service_Category_Entity.Services_Entity> multiple_image_list) {

        this.multiple_image_list = multiple_image_list;
        this.context = applicationContext;
        this.inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        //Log.e("Service_Type_Adapter","****************************");
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public ItemViewHolder(View itemView) {
            super(itemView);
            category_name= (TextView) itemView.findViewById(R.id.textView3);
            check_spareall= (ImageView) itemView.findViewById(R.id.check_commercial);
            layout_category= (ConstraintLayout) itemView.findViewById(R.id.constraintLayout_linear_comm);
    ...
    public void onBindViewHolder(final ItemViewHolder itemViewHolder, final int position) {
        ...
        itemViewHolder.category_name.setText(multiple_image_list.get(position).getService_name());
...
//
        ...
        itemViewHolder.layout_category.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (PlayStopButtonState == 1) {
                    ...
                    itemViewHolder.layout_category.setTag(2);
...
//                        }
                    ...
                    itemViewHolder.layout_category.setTag(1);
...
//        //Log.e("List","===="+multiple_image_list.get(position).getList());
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int position) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_service_type, parent, false);
        ItemViewHolder viewHolder = new ItemViewHolder(v);


        if (helper.driver_value.equals("0")) {
            for (int j = 0; j <  multiple_image_list.size(); j++) {
                if (! multiple_image_list.get(position).getService_name().equals("")) {
